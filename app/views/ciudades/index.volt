...
<?php
 ...
 echo $this->tag->select(array(
   'estado',
   Estados::find(array('order' => 'estado ASC')),
   'using' => array('id_estado', "estado"),
   'useEmpty' => true,
...
<!--
{{ text_field("ciudad", "class":"form-control", "required":"required", "placeholder":"Ciudad") }}
				...
				<table id="dynamic-table" class="table table-striped table-bordered table-hover">
					...
					<td>
						<div class="hidden-sm hidden-xs action-buttons">
	                        <?php echo $this->tag->linkTo(array("Ciudades/editar/".$row->ciudad, "<i class='ace-icon fa fa-pencil-square-o bigger-110'></i>"))  ?>
	                    </div> 
					</td>
					</tr>
					 <?php
