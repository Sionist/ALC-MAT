		...
		<script type="text/javascript">
			$(document).ready(function()
			{
				...
				$("#convenciones").on("change", function()
				{
					...
					$.get("clasificaciones/getclasifica", {"convenciones":id_convencion}, function(data)
					{
				...
				$("#cargar_clausula").on("change", function()
				{
					...
					$.get("clasificaciones/getmuestra", {"clausu":id_clausu}, function(data)
					{
				...
				$("#boton").click(function()
				{
					...
					$.get("clasificaciones/guardar", {"clausu":id_clausu}, function(data)
					{
