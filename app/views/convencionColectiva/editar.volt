        ...
        <div class="col-sm-4">
         <div class="widget-box">
            <div class="widget-header">
               <h4 class="widget-title">Editar Covenciones Colectivas</h4>
           </div>
           ...
           <div class="widget-body">
              <div class="widget-main no-padding">
                  ...
                  {{ form("convencion-colectiva/editado", "method":"post", "autocomplete" : "off", "class":"form-inline") }}
                  <fieldset>
                      {{ content() }}
                      {{ hidden_field("id") }}
                      ...
                      <table border="0" width="100%" cellspacing="0" cellpadding="0">
                         <tr>
                            ...
                            <td>{{ text_field("descripcion", "class":"form-control", "required":"required", "placeholder":"Descripcion") }}</td>
                        </tr>
                        
                        
                        <tr>
                            <td>Duración</td>
                            <td>{{ text_field("duracion", "class":"form-control", "required":"required", "placeholder":"Duracion") }}</td>
                        </tr>

                        
                        <tr>
                            <td>Estatus</td>
                            <td>{{ text_field("activa", "class":"form-control", "required":"required", "placeholder":"Estatus") }}</td>
                            
                        </tr>
                        
                        <tr>
                            <td>Fecha Convención</td>
                            <td>{{ text_field("fecha", "type":"date", "class":"form-control date-picker", "data-date-format":"yyyy-mm-dd", "required":"required") }}<i class="fa fa-calendar bigger-110"></i></td>
                        </tr>
                    </table>
