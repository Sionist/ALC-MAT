...
<div id="page-wrapper">
    ...
    <?php echo $this->tag->linkTo(array("deducciones/nueva-deduccion" ,"class"=>"btn btn-app btn-primary btn-xs", "<i class='ace-icon fa fa-folder bigger-160'></i>Nueva")); ?>
    <hr>
                ...
                <tbody>
                    ...
                    foreach($deducciones as $row) {
                        ...
                        <tr>
                            ...
                            <td><span style="text-transform: capitalize;"><?php echo $row->nb_deduccion; ?></span></td>

                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <?php echo $this->tag->linkTo(array("deducciones/editar/".$row->id_deduccion, "<i class='ace-icon fa fa-pencil-square-o bigger-110'></i>"))  ?>
                                </div>
                            </td>
                        </tr>
                        <?php
