...
{{ form("fondos/guardar", "method":"post", "autocomplete" : "off", "class":"form-inline") }}
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php echo $this->tag->linkTo(array("fondos/editar/".$row->id_fondo, "<i class='ace-icon fa fa-pencil-square-o bigger-110'></i>"))  ?>
                                                    </div>
                                                </td>
                                            </tr>
                                                <?php
