                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span style="text-transform: capitalize;"><?php echo $row->frecuencia; ?></span></td>
                                                        
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                    <?php echo $this->tag->linkTo(array("frecuencia/editar/".$row->id_frecuencia, "<i class='ace-icon fa fa-pencil-square-o bigger-110'></i>"))  ?>
                                                    </div>
                                                </td>
                                            </tr>
                                                <?php
