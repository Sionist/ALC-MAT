                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span style="text-transform: capitalize;"><?php echo $row->tasa; ?></span></td>
												
												<td><span style="text-transform: capitalize;"><?php echo $row->mes; ?></span></td>
												
												<td><span style="text-transform: capitalize;"><?php echo $row->ano_tasa; ?></span></td>
