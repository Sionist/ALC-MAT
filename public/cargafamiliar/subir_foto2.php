...
include("db/connexionPostgres.php");
...
$web_image_folder = 'modulos//administracion//familia';
$exts = 'JPG';
$image_name = $ide;
//echo $web_image_folder.'/'.$image_name.'.'.'JPG';

if(file_exists($web_image_folder.'/'.$image_name.'.png')) 
{ 
$archivo='0';
$foto_e= $ide.'.png';
}
if(file_exists($web_image_folder.'/'.$image_name.'.jpg')) 
{ 
$archivo='0';
$foto_e= $ide.'.jpg';
}
if(file_exists($web_image_folder.'/'.$image_name.'.bmp')) 
{ 
$archivo='0';
$foto_e= $ide.'.bmp';
}
...
<head>
  <title>Plan Salud - Subir o Actualizar Foto</title>
...
<input type="hidden" name="id" value="<?php echo mysql_result($sqlu, 0, id)?>" />
...
<div align="center"><img  name="miImagen"src="modulos//administracion//familia/<? if($archivo=='0'){echo "$foto_e";}else { if($archivo=='9') {echo "$foto_e";} else{echo "sinfoto.gif";}}?>" width="128" height="118" id="miImagen"/></div>
    ...
    <tr><td colspan="2" align="center">Extensiones Permitidas: <b>.jpg .png .bmp</b><br><br>Nombre de Archivo Sugerido:<font color=red><?php echo $ide.".jpg"; ?></font></td></tr>
    <tr>
...
<?php
       ...
       //configuracion
          ...
          $url="http://alcaldiadematurin.gob.ve/CF/"; //con / al final
          $carpeta="modulos/administracion/familia/"; //carpeta de las imagenes
      ...
      $actualiza_foto=pg_query("UPDATE data_personal SET foto_file='".$foto_nueva."' WHERE ide = '".$ide."'");


  //  $sql=mysql_query("UPDATE int_registrados SET imagen='$urlimagen' WHERE id='$_POST[id]'");
    

             ?>
                
                <h3>Foto Subida Correctamente</h3>
