...
<input type="hidden" name="id" value="<?php echo mysql_result($sql, 0, nu_cedula)?>" />
...
<div align="center"><img  name="miImagen" src="../../public/empleados/fotos/<?php if($archivo=='0'){echo "$foto_e";}else { if($archivo=='9') {echo "$foto_e";} else{echo "sinfoto.gif";}}?>" width="128" height="118" id="miImagen"/></div>
...
<?php
	   ...
	   $url="listado_personal.php"; //con / al final
          $carpeta="../../public/empleados/fotos/"; //carpeta de las imagenes
  ...
  $sql=mysql_query("UPDATE datospersonales SET foto_p='$laimagen' WHERE nu_cedula='$_POST[id]'");
